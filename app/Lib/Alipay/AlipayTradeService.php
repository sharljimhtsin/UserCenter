...
class AlipayTradeService
{
    ...
    function wapPay(AlipayTradeWapPayContentBuilder $builder, $return_url, $notify_url)
    {
    ...
    function aopclientRequestExecute(AlipayTradeWapPayRequest $request, $ispage = false)
    {
        $aop = new AopClient ();
    ...
    function Query(AlipayTradeWapPayContentBuilder $builder)
    {
        $biz_content = $builder->getBizContent();
        //打印业务参数
        $this->writeLog($biz_content);
